...
\addtolength{\evensidemargin}{-0.45cm}
...
\definecolor{yrMainColor}{RGB}{211,47,47}
\definecolor{yrSecondColor}{RGB}{255,193,7}
\definecolor{yrInk}{RGB}{27,32,40}
\definecolor{yrMuted}{gray}{0.45}
\color{yrInk}

\titleformat{\section}
  {\Large\bfseries\color{yrMainColor}}
  {}
  {0em}
  {\colorbox{yrMainColor!12}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{\thesection\hspace{0.6em}#1}}}
\titleformat{name=\section,numberless}
  {\Large\bfseries\color{yrMainColor}}
  {}
  {0em}
  {\colorbox{yrMainColor!12}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{#1}}}
\titleformat{\subsection}
  {\large\bfseries\color{yrMainColor!85!black}}
  {\color{yrMuted}\thesubsection}
  {0.6em}
  {#1}
...
\hypersetup{
  ...
  urlcolor=yrMainColor!75!black,
  citecolor=yrMainColor
}
...
% Colors for tables
\definecolor{TableHeader}{RGB}{252,240,240} % header background
\definecolor{TableRowOdd}{RGB}{255,248,246} % odd rows
\definecolor{TableRowEven}{RGB}{255,255,255} % even rows
\definecolor{TableLine}{RGB}{229,192,192}   % rule color
...
\newtcolorbox{mdblockquote}{
  ...
  enhanced,
  sharp corners,
  colback=yrMainColor!4!white,
  colframe=yrMainColor!45!black,
  boxrule=0.3pt,
  borderline west={2.0pt}{0pt}{yrMainColor},
  left=2.8mm,
  right=2.8mm,
  top=1.3mm,
  bottom=1.3mm
