...
\rhead{\small\sffamily\bfseries\thepage}
...
\definecolor{stlPrimary}{RGB}{0,0,90}
\definecolor{stlSecondary}{RGB}{0,20,20}
\definecolor{stlInk}{RGB}{20,20,35}
\color{stlInk}

\titleformat{\section}
  {\color{stlPrimary}\large\sffamily\bfseries}
  {}
  {0em}
  {\colorbox{stlSecondary!10}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{\raggedright\thesection.\space#1}}}
\titleformat{name=\section,numberless}
  {\color{stlPrimary}\large\sffamily\bfseries}
  {}
  {0em}
  {\colorbox{stlSecondary!10}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{\raggedright#1}}}
\titleformat{\subsection}
  {\color{stlPrimary}\sffamily\bfseries}
  {\thesubsection}
  {0.6em}
  {#1}
...
\hypersetup{
  ...
  urlcolor=stlSecondary,
  citecolor=stlPrimary
}
...
% Colors for tables
\definecolor{TableHeader}{RGB}{232,236,247} % header background
\definecolor{TableRowOdd}{RGB}{246,248,253} % odd rows
\definecolor{TableRowEven}{RGB}{255,255,255} % even rows
\definecolor{TableLine}{RGB}{196,203,224}   % rule color
...
\makeatletter
% longtable cannot run in global twocolumn mode; temporarily switch to one column.
\newif\ifmdpdf@restoretwocolumn
\pretocmd{\longtable}{%
  \if@twocolumn
    \mdpdf@restoretwocolumntrue
    \onecolumn
  \else
    \mdpdf@restoretwocolumnfalse
  \fi
}{}{}
\apptocmd{\endlongtable}{%
  \ifmdpdf@restoretwocolumn
    \twocolumn
  \fi
}{}{}
\makeatother
