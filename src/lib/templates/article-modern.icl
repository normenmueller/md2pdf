...
\usepackage{tocloft}
\setlength{\cftbeforesecskip}{2pt}     % spacing before \section entries
\setlength{\cftbeforesubsecskip}{1pt}  % spacing before \subsection entries
\makeatletter
...
\definecolor{mdModernInk}{HTML}{17232E}
\definecolor{mdModernPrimary}{HTML}{0E5E6F}
\definecolor{mdModernAccent}{HTML}{168A88}
\color{mdModernInk}

\titleformat{\section}
  {\Large\bfseries\color{mdModernPrimary}}
  {\thesection}{0.6em}{}
...
\hypersetup{
  ...
  urlcolor=mdModernAccent,
  citecolor=mdModernPrimary
}
...
% Colors for tables
\definecolor{TableHeader}{HTML}{E9F2F5} % header background
\definecolor{TableRowOdd}{HTML}{F7FAFC} % odd rows
\definecolor{TableRowEven}{HTML}{FFFFFF} % even rows
\definecolor{TableLine}{HTML}{C8D8E0}   % rule color
...
\newtcolorbox{mdblockquote}{
  ...
  enhanced,
  arc=1.2mm,
  colback=ocCynBack!30!white,
  colframe=mdModernAccent!45!black,
  boxrule=0.4pt,
  borderline west={1.6pt}{0pt}{mdModernAccent!75!black},
  left=2.5mm,
  right=2.5mm,
  top=1.4mm,
  bottom=1.4mm
